...
$('.checkout-button').click(function() {
  ...
  let total = coconut_mango_price * getQuantityCoconutMango;

  let messageText = 'New order from: ' + getName + ' in type: ' + getIcecreamType + '. Your total order cost is: $' + total.toFixed(2);
